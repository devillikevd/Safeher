<div align="center">
  ...
  <!-- BADGE MATRIX -->
  <a href="https://safeher-as4d.vercel.app/" target="_blank"><img src="https://img.shields.io/badge/🔴_LIVE_DEPLOYMENT-safeher--as4d.vercel.app-000000?style=for-the-badge&logo=vercel&logoColor=white" alt="Live" /></a>
  <img src="https://img.shields.io/badge/Build-Passing-00FF88?style=for-the-badge&logo=githubactions&logoColor=white" />
  <img src="https://img.shields.io/badge/Uptime-99.9%25-00F5FF?style=for-the-badge&logo=statuspage&logoColor=white" />
  
  <br/>

  <img src="https://img.shields.io/badge/Architecture-WebRTC_|_AI_|_Mesh_Network-0055FF?style=for-the-badge&logo=webrtc&logoColor=white" />
  <img src="https://img.shields.io/badge/Security-AES--256_|_SHA--256_|_HMAC-FF003C?style=for-the-badge&logo=letsencrypt&logoColor=white" />
  <img src="https://img.shields.io/badge/Platform-PWA_|_Cross--Browser_|_Edge--Ready-8B5CF6?style=for-the-badge&logo=googlechrome&logoColor=white" />

  <br/>

  <img src="https://img.shields.io/badge/Language-JavaScript_ES2024-F7DF1E?style=flat-square&logo=javascript&logoColor=black" />
  <img src="https://img.shields.io/badge/Backend-Supabase_Realtime-3ECF8E?style=flat-square&logo=supabase&logoColor=white" />
  <img src="https://img.shields.io/badge/Maps-Leaflet.js_1.9-199900?style=flat-square&logo=leaflet&logoColor=white" />
  <img src="https://img.shields.io/badge/SMS-Twilio_API-F22F46?style=flat-square&logo=twilio&logoColor=white" />
  <img src="https://img.shields.io/badge/Auth-Supabase_OTP-3ECF8E?style=flat-square&logo=supabase&logoColor=white" />
  <img src="https://img.shields.io/badge/Deploy-Vercel_Edge-000000?style=flat-square&logo=vercel&logoColor=white" />
  ...
  <a href="https://safeher-as4d.vercel.app/" target="_blank">
    <img src="https://img.shields.io/badge/⚡_ACCESS_LIVE_TERMINAL-Click_Here-FF003C?style=for-the-badge&logo=windowsterminal&logoColor=white" />
  </a>
...
graph TB
    subgraph "CLIENT LAYER"
        A[SafeHer OS - Browser Runtime] --> B{Hardware Abstraction Layer}
        B -->|Microphone Array| C[Voice Guardian AI]
        B -->|Optical Sensors| D[Evidence Engine & Spy Detector]
        B -->|GPS + Gyroscope| E[Telemetry Engine]
        B -->|Accelerometer| F[Shake-to-SOS Module]
    end

    subgraph "PROCESSING LAYER"
        C -->|Keyword Match| G[SOS Event Bus]
        E -->|Anomaly Detection| G
        F -->|Motion Threshold| G
        G -->|Dispatch| H[MediaRecorder Pipeline]
        G -->|Dispatch| I[SMS API Gateway]
        G -->|Dispatch| J[Supabase Realtime Channel]
    end

    subgraph "STORAGE LAYER"
        H -->|Blob Chunks| K[(IndexedDB - Evidence Vault)]
        K -->|Auto-Download| L[Local Filesystem Backup]
        H -->|SHA-256 Hash| M[Chain-of-Custody Log]
    end

    subgraph "EXTERNAL SERVICES"
        I -->|REST API| N[Twilio SMS Gateway]
        J -->|WebSocket| O[Guardian Live Tracking View]
        P[Supabase Auth] -->|OTP via SMS| A
    end

    style A fill:#1a1a2e,stroke:#FF003C,color:#fff
    style G fill:#FF003C,stroke:#fff,color:#fff
    style K fill:#0f3460,stroke:#00F5FF,color:#fff
    style N fill:#F22F46,stroke:#fff,color:#fff
```
...
```mermaid
sequenceDiagram
    participant User as SafeHer Operator
    participant App as SafeHer OS (Client)
    participant Supa as Supabase Realtime
    participant Twilio as Twilio SMS API
    participant Guardian as Guardian (Browser)

    User->>App: Voice Command "HELP"
    App->>App: SpeechRecognition → Keyword Match
    App->>App: Activate SOS Event Bus
    
    par Evidence Capture
        App->>App: Start MediaRecorder (Video+Audio)
        App->>App: Capture Photo Snapshot
        App->>App: Store in IndexedDB + Auto-Download
    and SMS Dispatch
        App->>Twilio: POST /api/send-sos
        Twilio->>Guardian: SMS with GPS coordinates
    and Live Tracking
        App->>Supa: Broadcast GPS via Realtime Channel
        Supa->>Guardian: WebSocket Location Updates
        Guardian->>Guardian: Render Live Map Marker
    end
    
    Note over App: Evidence files SHA-256 hashed<br/>Chain-of-custody secured
```
...
<div align="center">
  <br/>
  <img src="https://readme-typing-svg.demolab.com?font=Share+Tech+Mono&size=18&pause=1000&color=00F5FF&center=true&vCenter=true&random=false&width=500&lines=%5B+EOF%3A+SYSTEM+ARMED+%26+OPERATIONAL+%5D" alt="EOF" />
  <br/><br/>
  <strong>Designed, Architected, and Engineered by Team Code Clash</strong>
  <br/>
  <sub>Anushka Upadhyay • Vyom Dubey</sub>
  <br/><br/>
  <img src="https://img.shields.io/badge/Made_with-❤️_and_JavaScript-FF003C?style=flat-square" />
</div>
